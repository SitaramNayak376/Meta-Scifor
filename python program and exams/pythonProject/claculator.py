...
# Function to update the entry widget with the button clicked
...
entry = tk.Entry(root, width=16, font=('Arial', 18), borderwidth=2, relief="solid")
...
button_add = tk.Button(root, text="+", padx=20, pady=20, command=lambda: button_operator("+"))
button_subtract = tk.Button(root, text="-", padx=20, pady=20, command=lambda: button_operator("-"))
button_multiply = tk.Button(root, text="*", padx=20, pady=20, command=lambda: button_operator("*"))
button_divide = tk.Button(root, text="/", padx=20, pady=20, command=lambda: button_operator("/"))
